...
class CamGPTModel:
    ...
    def __init__(self, details: dict) -> None:
        ...
        self.llm = OpenAI(
            ...
            maxTokens = 4096,
            apiKey="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"
        )
